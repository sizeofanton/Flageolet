package com.sizeofanton.flageolet.forth_octave_tests
...
class G4Test {
    ...
    @Test
    fun test_detect() {
        ZenTone.getInstance().generate(392, 3, 1f) {}
        Thread.sleep(3000)
        Espresso.onView(ViewMatchers.withId(R.id.tvNote))
            .check(ViewAssertions.matches(ViewMatchers.withText(Matchers.containsString("G4"))))
